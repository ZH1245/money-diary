...
import type { TransactionFormState, TransactionTableRow } from '#/features/transactions/utils/transaction-display'
import {
 ...
 */
export function TransactionsPageContent({ userCurrency }: TransactionsPageContentProps) {
